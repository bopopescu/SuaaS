...
class ClusterManagerClient(object):
    ...
    def __init__(self,
        ...
        self._update_main = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_manager_stub.UpdateMain,
            default_retry=method_configs['UpdateMain'].retry,
            default_timeout=method_configs['UpdateMain'].timeout,
            client_info=client_info,
        )
        self._set_main_auth = google.api_core.gapic_v1.method.wrap_method(
            self.cluster_manager_stub.SetMainAuth,
            default_retry=method_configs['SetMainAuth'].retry,
            default_timeout=method_configs['SetMainAuth'].timeout,
            client_info=client_info,
        )
    ...
    def update_main(self,
        ...
        Example:
            ...
            >>> main_version = ''
            >>>
            >>> response = client.update_main(project_id, zone, cluster_id, main_version)
        ...
        Args:
            ...
            zone (str): The name of the Google Compute Engine
                ...
                resides.
            cluster_id (str): The name of the cluster to upgrade.
            main_version (str): The Kubernetes version to change the main to. The only valid value is the
        ...
        Raises:
            ...
            ValueError: If the parameters are invalid.
        """
        request = cluster_service_pb2.UpdateMainRequest(
            project_id=project_id,
            zone=zone,
            cluster_id=cluster_id,
            main_version=main_version,
        )
        return self._update_main(request, retry=retry, timeout=timeout)

    def set_main_auth(self,
                        project_id,
                        zone,
                        cluster_id,
                        action,
        ...
        Example:
            ...
            >>> zone = ''
            >>> cluster_id = ''
            >>> action = enums.SetMainAuthRequest.Action.UNKNOWN
            >>> update = {}
            >>>
            >>> response = client.set_main_auth(project_id, zone, cluster_id, action, update)
        ...
        Args:
            ...
            zone (str): The name of the Google Compute Engine
                ...
                resides.
            cluster_id (str): The name of the cluster to upgrade.
            action (~google.cloud.container_v1.types.Action): The exact form of action to be taken on the main auth.
            update (Union[dict, ~google.cloud.container_v1.types.MainAuth]): A description of the update.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.container_v1.types.MainAuth`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Raises:
            ...
            ValueError: If the parameters are invalid.
        """
        request = cluster_service_pb2.SetMainAuthRequest(
            project_id=project_id,
            zone=zone,
            cluster_id=cluster_id,
            action=action,
        ...
        return self._set_main_auth(request, retry=retry, timeout=timeout)
