...
_SETMASTERAUTHREQUEST_ACTION = _descriptor.EnumDescriptor(
  name='Action',
  full_name='google.container.v1.SetMainAuthRequest.Action',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MASTERAUTH = _descriptor.Descriptor(
  name='MainAuth',
  full_name='google.container.v1.MainAuth',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='username', full_name='google.container.v1.MainAuth.username', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='password', full_name='google.container.v1.MainAuth.password', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='client_certificate_config', full_name='google.container.v1.MainAuth.client_certificate_config', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_ca_certificate', full_name='google.container.v1.MainAuth.cluster_ca_certificate', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='client_certificate', full_name='google.container.v1.MainAuth.client_certificate', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='client_key', full_name='google.container.v1.MainAuth.client_key', index=5,
...
_MASTERAUTHORIZEDNETWORKSCONFIG_CIDRBLOCK = _descriptor.Descriptor(
  name='CidrBlock',
  full_name='google.container.v1.MainAuthorizedNetworksConfig.CidrBlock',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.container.v1.MainAuthorizedNetworksConfig.CidrBlock.display_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cidr_block', full_name='google.container.v1.MainAuthorizedNetworksConfig.CidrBlock.cidr_block', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MASTERAUTHORIZEDNETWORKSCONFIG = _descriptor.Descriptor(
  name='MainAuthorizedNetworksConfig',
  full_name='google.container.v1.MainAuthorizedNetworksConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='enabled', full_name='google.container.v1.MainAuthorizedNetworksConfig.enabled', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cidr_blocks', full_name='google.container.v1.MainAuthorizedNetworksConfig.cidr_blocks', index=1,
...
_CLUSTER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='main_auth', full_name='google.container.v1.Cluster.main_auth', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='main_authorized_networks_config', full_name='google.container.v1.Cluster.main_authorized_networks_config', index=19,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_main_version', full_name='google.container.v1.Cluster.current_main_version', index=25,
...
_CLUSTERUPDATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='desired_main_authorized_networks_config', full_name='google.container.v1.ClusterUpdate.desired_main_authorized_networks_config', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='desired_main_version', full_name='google.container.v1.ClusterUpdate.desired_main_version', index=8,
      number=100, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEMASTERREQUEST = _descriptor.Descriptor(
  name='UpdateMainRequest',
  full_name='google.container.v1.UpdateMainRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='project_id', full_name='google.container.v1.UpdateMainRequest.project_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='zone', full_name='google.container.v1.UpdateMainRequest.zone', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_id', full_name='google.container.v1.UpdateMainRequest.cluster_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='main_version', full_name='google.container.v1.UpdateMainRequest.main_version', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SETMASTERAUTHREQUEST = _descriptor.Descriptor(
  name='SetMainAuthRequest',
  full_name='google.container.v1.SetMainAuthRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='project_id', full_name='google.container.v1.SetMainAuthRequest.project_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='zone', full_name='google.container.v1.SetMainAuthRequest.zone', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_id', full_name='google.container.v1.SetMainAuthRequest.cluster_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='action', full_name='google.container.v1.SetMainAuthRequest.action', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.container.v1.SetMainAuthRequest.update', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_main_versions', full_name='google.container.v1.ServerConfig.valid_main_versions', index=4,
...
_CLUSTER.fields_by_name['main_auth'].message_type = _MASTERAUTH
...
_CLUSTER.fields_by_name['main_authorized_networks_config'].message_type = _MASTERAUTHORIZEDNETWORKSCONFIG
...
_CLUSTERUPDATE.fields_by_name['desired_main_authorized_networks_config'].message_type = _MASTERAUTHORIZEDNETWORKSCONFIG
...
DESCRIPTOR.message_types_by_name['MainAuth'] = _MASTERAUTH
...
DESCRIPTOR.message_types_by_name['MainAuthorizedNetworksConfig'] = _MASTERAUTHORIZEDNETWORKSCONFIG
...
DESCRIPTOR.message_types_by_name['UpdateMainRequest'] = _UPDATEMASTERREQUEST
DESCRIPTOR.message_types_by_name['SetMainAuthRequest'] = _SETMASTERAUTHREQUEST
...
MainAuth = _reflection.GeneratedProtocolMessageType('MainAuth', (_message.Message,), dict(
  DESCRIPTOR = _MASTERAUTH,
  __module__ = 'google.cloud.container_v1.proto.cluster_service_pb2'
  ,
  __doc__ = """The authentication information for accessing the main endpoint.
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.container.v1.MainAuth)
  ))
_sym_db.RegisterMessage(MainAuth)
...
AddonsConfig = _reflection.GeneratedProtocolMessageType('AddonsConfig', (_message.Message,), dict(
  ...
  Attributes:
      ...
      network_policy_config:
          ...
          addon is enabled or not on the Main, it does not track
...
MainAuthorizedNetworksConfig = _reflection.GeneratedProtocolMessageType('MainAuthorizedNetworksConfig', (_message.Message,), dict(
  ...
  CidrBlock = _reflection.GeneratedProtocolMessageType('CidrBlock', (_message.Message,), dict(
    ...
    """,
    # @@protoc_insertion_point(class_scope:google.container.v1.MainAuthorizedNetworksConfig.CidrBlock)
    ))
  ,
  DESCRIPTOR = _MASTERAUTHORIZEDNETWORKSCONFIG,
  __module__ = 'google.cloud.container_v1.proto.cluster_service_pb2'
  ,
  __doc__ = """Main authorized networks is a Beta feature. Configuration options for
  the main authorized networks feature. Enabled main authorized
  networks will disallow all external traffic to access Kubernetes main
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.container.v1.MainAuthorizedNetworksConfig)
  ))
_sym_db.RegisterMessage(MainAuthorizedNetworksConfig)
_sym_db.RegisterMessage(MainAuthorizedNetworksConfig.CidrBlock)
...
Cluster = _reflection.GeneratedProtocolMessageType('Cluster', (_message.Message,), dict(
  ...
  Attributes:
      ...
      main_auth:
          The authentication information for accessing the main
          endpoint.
      logging_service:
      ...
      enable_kubernetes_alpha:
          ...
          main and nodes. The cluster has no SLA for uptime and
          main/node upgrades are disabled. Alpha enabled clusters are
      ...
      main_authorized_networks_config:
          Main authorized networks is a Beta feature. The
          configuration options for main authorized networks feature.
      maintenance_policy:
      ...
      zone:
          ...
          resides.
      endpoint:
          [Output only] The IP address of this cluster's main
          endpoint. The endpoint can be accessed from the internet at
          ``https://username:password@endpoint/``.  See the
          ``mainAuth`` property of this resource for username and
          password information.
      initial_cluster_version:
          The initial Kubernetes version for this cluster. Valid
          versions are those found in validMainVersions returned by
          getServerConfig. The version can be upgraded over time; such
          upgrades are reflected in currentMainVersion and
          currentNodeVersion.
      current_main_version:
          [Output only] The current software version of the main
          endpoint.
...
ClusterUpdate = _reflection.GeneratedProtocolMessageType('ClusterUpdate', (_message.Message,), dict(
  ...
  Attributes:
      ...
      desired_locations:
          ...
          zone.
      desired_main_authorized_networks_config:
          Main authorized networks is a Beta feature. The desired
          configuration options for main authorized networks feature.
      desired_main_version:
          The Kubernetes version to change the main to. The only valid
...
UpdateMainRequest = _reflection.GeneratedProtocolMessageType('UpdateMainRequest', (_message.Message,), dict(
  DESCRIPTOR = _UPDATEMASTERREQUEST,
  __module__ = 'google.cloud.container_v1.proto.cluster_service_pb2'
  ,
  __doc__ = """UpdateMainRequest updates the main of the cluster.
  ...
  Attributes:
      ...
      main_version:
          ...
          server automatically select the latest version.
  """,
  # @@protoc_insertion_point(class_scope:google.container.v1.UpdateMainRequest)
  ))
_sym_db.RegisterMessage(UpdateMainRequest)

SetMainAuthRequest = _reflection.GeneratedProtocolMessageType('SetMainAuthRequest', (_message.Message,), dict(
  DESCRIPTOR = _SETMASTERAUTHREQUEST,
  __module__ = 'google.cloud.container_v1.proto.cluster_service_pb2'
  ,
  __doc__ = """SetMainAuthRequest updates the admin password of a cluster.
  ...
  Attributes:
      ...
      update:
          A description of the update.
  """,
  # @@protoc_insertion_point(class_scope:google.container.v1.SetMainAuthRequest)
  ))
_sym_db.RegisterMessage(SetMainAuthRequest)
...
NodePool = _reflection.GeneratedProtocolMessageType('NodePool', (_message.Message,), dict(
  ...
  and specification, under the control of the cluster main. They may
...
CompleteIPRotationRequest = _reflection.GeneratedProtocolMessageType('CompleteIPRotationRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.container_v1.proto.cluster_service_pb2'
  ,
  __doc__ = """CompleteIPRotationRequest moves the cluster main back into single-IP
  mode.
...
try:
  ...
  class ClusterManagerStub(object):
    ...
    def __init__(self, channel):
      ...
      self.UpdateMain = channel.unary_unary(
          '/google.container.v1.ClusterManager/UpdateMain',
          request_serializer=UpdateMainRequest.SerializeToString,
          response_deserializer=Operation.FromString,
          )
      self.SetMainAuth = channel.unary_unary(
          '/google.container.v1.ClusterManager/SetMainAuth',
          request_serializer=SetMainAuthRequest.SerializeToString,
          response_deserializer=Operation.FromString,
          )
  ...
  class ClusterManagerServicer(object):
    ...
    def UpdateMain(self, request, context):
    ...
    def SetMainAuth(self, request, context):
  ...
  def add_ClusterManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'UpdateMain': grpc.unary_unary_rpc_method_handler(
            servicer.UpdateMain,
            request_deserializer=UpdateMainRequest.FromString,
            response_serializer=Operation.SerializeToString,
        ),
        'SetMainAuth': grpc.unary_unary_rpc_method_handler(
            servicer.SetMainAuth,
            request_deserializer=SetMainAuthRequest.FromString,
            response_serializer=Operation.SerializeToString,
        ),
  ...
  class BetaClusterManagerStub(object):
    ...
    def UpdateMain(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """Updates the main of a specific cluster.
      """
      raise NotImplementedError()
    UpdateMain.future = None
    def SetMainAuth(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """Used to set main auth materials. Currently supports :-
      Changing the admin password of a specific cluster.
      This can be either via password generation or explicitly set the password.
      """
      raise NotImplementedError()
    SetMainAuth.future = None
  ...
  def beta_create_ClusterManager_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('google.container.v1.ClusterManager', 'SetMainAuth'): SetMainAuthRequest.FromString,
      ...
      ('google.container.v1.ClusterManager', 'UpdateMain'): UpdateMainRequest.FromString,
    ...
    response_serializers = {
      ...
      ('google.container.v1.ClusterManager', 'SetMainAuth'): Operation.SerializeToString,
      ...
      ('google.container.v1.ClusterManager', 'UpdateMain'): Operation.SerializeToString,
    ...
    method_implementations = {
      ...
      ('google.container.v1.ClusterManager', 'SetMainAuth'): face_utilities.unary_unary_inline(servicer.SetMainAuth),
      ...
      ('google.container.v1.ClusterManager', 'UpdateMain'): face_utilities.unary_unary_inline(servicer.UpdateMain),
  ...
  def beta_create_ClusterManager_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('google.container.v1.ClusterManager', 'SetMainAuth'): SetMainAuthRequest.SerializeToString,
      ...
      ('google.container.v1.ClusterManager', 'UpdateMain'): UpdateMainRequest.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('google.container.v1.ClusterManager', 'SetMainAuth'): Operation.FromString,
      ...
      ('google.container.v1.ClusterManager', 'UpdateMain'): Operation.FromString,
    ...
    cardinalities = {
      ...
      'SetMainAuth': cardinality.Cardinality.UNARY_UNARY,
      ...
      'UpdateMain': cardinality.Cardinality.UNARY_UNARY,
