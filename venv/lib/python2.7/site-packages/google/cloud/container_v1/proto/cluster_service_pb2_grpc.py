...
import google.cloud.container_v1.proto.cluster_service_pb2 as google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2
...
class ClusterManagerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UpdateMain = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.UpdateMainRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.Operation.FromString,
        )
    self.SetMainAuth = channel.unary_unary(
        '/google.container.v1.ClusterManager/SetMainAuth',
        request_serializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.SetMainAuthRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.Operation.FromString,
        )
...
def add_ClusterManagerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'UpdateMain': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateMain,
          request_deserializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.UpdateMainRequest.FromString,
          response_serializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.Operation.SerializeToString,
      ),
      'SetMainAuth': grpc.unary_unary_rpc_method_handler(
          servicer.SetMainAuth,
          request_deserializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.SetMainAuthRequest.FromString,
          response_serializer=google_dot_cloud_dot_container__v1_dot_proto_dot_cluster__service__pb2.Operation.SerializeToString,
      ),
