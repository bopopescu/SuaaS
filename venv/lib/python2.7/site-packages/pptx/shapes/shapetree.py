...
from .placeholder import (
    ChartPlaceholder, LayoutPlaceholder, MainPlaceholder,
...
class _BaseShapes(ParentedElementProxy):
    ...
    include Slide, SlideLayout, and SlideMain, providing common methods.
    """
...
class BasePlaceholders(_BaseShapes):
    ...
    a main, layout, and slide. By default, placeholder shapes are
...
class MainPlaceholders(BasePlaceholders):
    """
    Sequence of _MainPlaceholder instances representing the placeholder
    shapes on a slide main.
    """
    ...
    def _shape_factory(self, shape_elm):
        ...
        *shape_elm*.
        """
        return _MainShapeFactory(shape_elm, self)


class MainShapes(_BaseShapes):
    """
    Sequence of shapes appearing on a slide main. The first shape in the
    sequence is the backmost in z-order and the last shape is topmost.
...
def _MainShapeFactory(shape_elm, parent):
    """
    Return an instance of the appropriate shape proxy class for *shape_elm*
    on a slide main.
    """
    tag_name = shape_elm.tag
    if tag_name == qn('p:sp') and shape_elm.has_ph_elm:
        return MainPlaceholder(shape_elm, parent)
    return BaseShapeFactory(shape_elm, parent)


class NotesSlidePlaceholders(MainPlaceholders):
    """
